...
background-image: radial-gradient(650px circle at 0% 0%, hsl(218, 41%, 50%) 15%, hsl(218, 41%, 40%) 35%, hsl(218, 41%, 30%) 75%, hsl(218, 41%, 25%) 80%, transparent 100%),
                  radial-gradient(1250px circle at 100% 100%, hsl(218, 41%, 60%) 15%, hsl(218, 41%, 40%) 35%, hsl(218, 41%, 30%) 75%, hsl(218, 41%, 25%) 80%, transparent 100%);
					...
					<div class="card bg-glass">
						<div class="card-body px-4 py-5 px-md-5">
							<form action='register' method='post' onsubmit="return validateForm()">
								...
								<p style="text-align: center ;margin-bottom: 20px;" >Lorem Ipsum is simply dummy text of the printing and
									...
									<div class="row">
						                <div class="col-md-6 mb-4">
						                  <div class="form-outline">
											  ...
											  <label class="form-label" for="form3Example1">Salutation</label>
											</div>
						                </div>
						                <div class="col-md-6 mb-4">
						                  <div class="form-outline">
						             ...
						             <div class="row">
						                <div class="col-md-6 mb-4">
						                  <div class="form-outline">
											  <input type="text" id="tele" name='tell' class="form-control" />
						             ...
						             <div class="row">
						                ...
						                <div class="col-md-6 mb-4">
						                  <div class="form-outline">
                							...
                							<label class="form-label" for="form3Example4" name='username'>Password</label>
						                  </div>
						                </div>
						             </div>
              <!-- Submit button -->
...
function validateForm() {
    ...
    if (username.trim() === "" || pwd.trim() === "" || salutation.trim() === "" || firstname.trim() === "" || lastname.trim() === "" || tele.trim() === "" || address.trim() === ""  ) {
