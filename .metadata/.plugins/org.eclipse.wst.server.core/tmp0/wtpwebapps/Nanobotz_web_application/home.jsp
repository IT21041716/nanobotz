...
<body>
	...
	<div class='hero_section'>
		<h3 class='hero-hed'>CLASSIC & TIMELESS HAND CRAFT GOODS</h3>
	</div>

	<div class='container1'>
		<p>"YOU MUST JUDGE A MAN BY THE WORK OF HIS HANDS."</p>
	</div>
	...
	<div class='container2'>
		...
		<div class='inner' id= 'bx1'>
			<div class="card">
				<img
					src="https://images.unsplash.com/photo-1621371205896-3082fa811d54?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGhhbmRjcmFmdHxlbnwwfDB8MHx8fDA%3D"
					class="card-img-top" alt="Product Image">
				<div class="card-body">
					<h5 class="card-title">Hand-sewn Leather Wallet in Coffee</h5>
					<p class="card-text">Moose</p>
				</div>
			</div>
		</div>
		<div class='inner' id= 'bx2'>
			<div class="card" >
				<img
					src="https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8aGFuZCUyMGNyYWZ0fGVufDB8MHwwfHx8MA%3D%3D"
					class="card-img-top" alt="Product Image">
				<div class="card-body">
					<h5 class="card-title">Hand-sewn Leather Wallet in Coffee</h5>
					<p class="card-text">Moose</p>
		...
		<div class='inner' id= 'bx3'>
			<div class="card">
				<img
					src="https://images.unsplash.com/photo-1568288796918-03e7d93306bd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGhhbmQlMjBjcmFmdHxlbnwwfDB8MHx8fDA%3D"
					class="card-img-top" alt="Product Image">
				<div class="card-body">
					<h5 class="card-title">Hand-sewn Leather Wallet in Coffee</h5>
					<p class="card-text">Moose</p>
